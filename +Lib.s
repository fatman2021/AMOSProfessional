...
IfSa:
    ...
    divu    #3,d0               ; D0 = CMAP Color amount
...
IfSb:
    ...
    dbra    d0,IfSb
IfSc:
;    cmp.l   #32,d3                  ; 2019.11.18 Adding to select which palette mode we update. ECS or AGA
;    bhi     IFFAgaVersion           ; 2019.11.18 If more than 32 Colors, then -> Jump to AGA palette update.
;    EcCall    SPal
;    rts
