#ifndef INLINE_GALLIUM_H
#define INLINE_GALLIUM_H
...
/*
    Desc: Inline function(s) for gallium
*/
...
static inline PipeHandle_t __inline_Gallium_CreatePipe(struct TagItem * __arg1, APTR __GalliumBase)
{
    AROS_LIBREQ(GalliumBase, 4)
    return AROS_LC1(PipeHandle_t, CreatePipe,
        AROS_LCA(struct TagItem *,(__arg1),A0),
        struct Library *, (__GalliumBase), 5, Gallium    );
}

#define CreatePipe(arg1) \
    __inline_Gallium_CreatePipe((arg1), __GALLIUM_LIBBASE)
...
static inline void __inline_Gallium_DestroyPipe(PipeHandle_t __arg1, APTR __GalliumBase)
{
    AROS_LIBREQ(GalliumBase, 4)
...
#define DestroyPipe(arg1) \
    __inline_Gallium_DestroyPipe((arg1), __GALLIUM_LIBBASE)

#endif /* !defined(__GALLIUM_LIBAPI__) || (4 <= __GALLIUM_LIBAPI__) */

#if !defined(__GALLIUM_LIBAPI__) || (4 <= __GALLIUM_LIBAPI__)

static inline PipeScreen_t __inline_Gallium_CreatePipeScreen(PipeHandle_t __arg1, APTR __GalliumBase)
{
    AROS_LIBREQ(GalliumBase, 4)
    return AROS_LC1(PipeScreen_t, CreatePipeScreen,
        AROS_LCA(PipeHandle_t,(__arg1),A0),
        struct Library *, (__GalliumBase), 7, Gallium    );
}

#define CreatePipeScreen(arg1) \
    __inline_Gallium_CreatePipeScreen((arg1), __GALLIUM_LIBBASE)

#endif /* !defined(__GALLIUM_LIBAPI__) || (4 <= __GALLIUM_LIBAPI__) */

#if !defined(__GALLIUM_LIBAPI__) || (4 <= __GALLIUM_LIBAPI__)

static inline void __inline_Gallium_DestroyPipeScreen(PipeHandle_t __arg1, PipeScreen_t __arg2, APTR __GalliumBase)
{
    AROS_LIBREQ(GalliumBase, 4)
...
#define DestroyPipeScreen(arg1, arg2) \
    __inline_Gallium_DestroyPipeScreen((arg1), (arg2), __GALLIUM_LIBBASE)

#endif /* !defined(__GALLIUM_LIBAPI__) || (4 <= __GALLIUM_LIBAPI__) */

#if !defined(__GALLIUM_LIBAPI__) || (4 <= __GALLIUM_LIBAPI__)

static inline void __inline_Gallium_BltPipeResourceRastPort(PipeHandle_t __arg1, APTR __arg2, LONG __arg3, LONG __arg4, struct RastPort * __arg5, LONG __arg6, LONG __arg7, LONG __arg8, LONG __arg9, APTR __GalliumBase)
{
    AROS_LIBREQ(GalliumBase, 4)
...
#define BltPipeResourceRastPort(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) \
    __inline_Gallium_BltPipeResourceRastPort((arg1), (arg2), (arg3), (arg4), (arg5), (arg6), (arg7), (arg8), (arg9), __GALLIUM_LIBBASE)

#endif /* !defined(__GALLIUM_LIBAPI__) || (4 <= __GALLIUM_LIBAPI__) */

#endif /* INLINE_GALLIUM_H*/
