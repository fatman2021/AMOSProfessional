/*
**  $VER: ConfigFile.h 2.2 (13.2.97)
**
**  C header for the ConfigFile.library
**
...
#define CF_OMODE_OLDFILE    0x00
#define CF_OMODE_NEWFILE    0x01
#define CF_OMODE_READWRITE  0x02
...
#define CF_OFLG_READ_TOO    0x00000004
...
#define CF_WMODE_DEFAULT    0x00
#define CF_WMODE_SHORT      0x01
#define CF_WMODE_ASCII      0x02
...
#define CF_WFLG_WRITE_ALWAYS  0x00000004
...
#define CF_OERR_UNKOWN        0x00
#define CF_OERR_OPEN_FILE     0x01
#define CF_OERR_READ_FILE     0x02
#define CF_OERR_NO_FORMAT     0x03
#define CF_OERR_NO_SIZE       0x04
#define CF_OERR_HEADER_MEM    0x05

#define CF_RERR_UNKOWN        0x00
#define CF_RERR_BUFFER_MEM    0x01
#define CF_RERR_READ_FILE     0x02

#define CF_RERR_FORMAT        0x06
#define CF_RERR_UNKOWN_ITYPE  0x07

#define CF_WERR_UNKOWN        0x00
#define CF_WERR_ALLOC_WBUFFER 0x01
...
#define CF_ITYP_STRING    0x01
#define CF_ITYP_NUMBER    0x02
#define CF_ITYP_BOOL      0x03
...
#define CF_STYP_BOOL_DEFAULT 0x00
#define CF_STYP_BOOL_TRUE    0x01
#define CF_STYP_BOOL_YES     0x02
#define CF_STYP_BOOL_ON      0x03

#define CF_STYP_NUM_DEFAULT  0x00
#define CF_STYP_NUM_DEC      0x01
#define CF_STYP_NUM_HEX      0x02
#define CF_STYP_NUM_BIN      0x03
...
#define CF_HFLG_SHORT_FILE     0x00000001
#define CF_HFLG_ASCII_FILE     0x00000002

#define CF_HFLG_CHANGED        0x00000004
#define CF_HFLG_WRITE_BY_CLOSE 0x00000008
...
typedef ULONG	CFGroup;
typedef ULONG	CFArgument;
typedef ULONG	CFItem;
...
#define cf_NewString(ArgNode,String)  cf_NewItem (ArgNode, (LONG)String, CF_ITYP_STRING, NULL)
