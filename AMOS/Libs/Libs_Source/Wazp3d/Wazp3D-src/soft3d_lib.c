...
/* This file contain the SOFT3D library header				*/
/* WARNING: This file must be compiled without optimisation		*/
/* (Because there is inlined ASM for native calls to the DLL)	*/

#if defined(__GNUC__) && defined(__mc68000__)
asm ("jra _ReturnError");
#endif
/*======================================================================================*/
#define NAMETXT    "soft3d"
#define VERSION    50
#define REVISION   0
#define DATETXT    "18.11.2010"
#define VERSTXT    "50.0"
#define LIBINIT    SOFT3D_Init
#define LIBEXPUNGE SOFT3D_Close
/*======================================================================================*/
...
#include "soft3d_functions_glue.h"
/*======================================================================================*/
struct LibInitData {
