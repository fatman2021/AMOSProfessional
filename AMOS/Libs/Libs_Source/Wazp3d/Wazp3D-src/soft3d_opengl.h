...
void HARD3D_Fog(void *gc,unsigned char FogMode,float FogZmin,float FogZmax,float FogDensity,const unsigned char *FogRGBA);
...
void HARD3D_SetBackColor(void *gc,const unsigned char  *RGBA);
...
void HARD3D_SetCurrentColor(void *gc,const unsigned char  *RGBA);
...
void HARD3D_WriteZSpan(void *gc, unsigned short x, unsigned short y,unsigned long n, const double *dz, const unsigned char *mask);
