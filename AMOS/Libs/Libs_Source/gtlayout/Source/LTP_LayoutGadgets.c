				...
				switch(Node->Type)
				{
					...
					#ifdef DO_TEXTEDIT_KIND
					{
						case TEXTEDIT_KIND:
							...
							Gadget = NewObject(LTP_TextEditClass,NULL,
								GA_Left,			NewGadget.ng_LeftEdge,
								GA_Top,				NewGadget.ng_TopEdge,
								GA_Width,			NewGadget.ng_Width,
								GA_Height,			NewGadget.ng_Height,
								...
								GA_UserData,		Node,
								GA_RelVerify,		TRUE,
								GA_DrawInfo,		Handle->DrawInfo,
								GA_TabCycle,		TRUE,
								GA_Immediate,		TRUE,
								STRINGA_Buffer,		Node->Special.TextEdit.String,
								STRINGA_Font,		Node->Special.TextEdit.Font,
