...
BOOL LTP_DrawGroupMember(LayoutHandle *Handle, ObjectNode *Group, LONG id);
...
/* LTP_TextEdit.c */
VOID TE_GetTextEditString(struct TextEditContext *tec, STRPTR *stringPtr);
BOOL TE_SetTextEditString(struct TextEditContext *tec, STRPTR string);
VOID TE_GetTextEditStringPosition(struct TextEditContext *tec, LONG *positionPtr);
VOID TE_SetTextEditStringPosition(struct TextEditContext *tec, LONG position);
VOID TE_DeleteTextEditContext(struct TextEditContext *tec);
struct TextEditContext *TE_CreateTextEditContext(struct DrawInfo *dri, struct TextFont *font);
VOID TE_SetTextEditBox(struct TextEditContext *tec, struct IBox *box);
VOID TE_SetTextEditRastPort(struct TextEditContext *tec, struct RastPort *rastPort);
BOOL TE_AddString(struct TextEditContext *tec, UBYTE *string, LONG len);
VOID TE_RemoveChars(struct TextEditContext *tec, LONG numChars);
VOID TE_DeleteChars(struct TextEditContext *tec, LONG numChars);
VOID TE_DeleteToStartOfLine(struct TextEditContext *tec);
VOID TE_DeleteToEndOfLine(struct TextEditContext *tec);
VOID TE_DeleteAll(struct TextEditContext *tec);
VOID TE_RemoveWord(struct TextEditContext *tec);
VOID TE_RestoreBackup(struct TextEditContext *tec);
VOID TE_CursorFirstLine(struct TextEditContext *tec);
VOID TE_CursorLastLine(struct TextEditContext *tec);
VOID TE_CursorStartOfLine(struct TextEditContext *tec);
VOID TE_CursorEndOfLine(struct TextEditContext *tec);
VOID TE_CursorPageUp(struct TextEditContext *tec);
VOID TE_CursorPageDown(struct TextEditContext *tec);
VOID TE_CursorUp(struct TextEditContext *tec, LONG numLines);
VOID TE_CursorDown(struct TextEditContext *tec, LONG numLines);
VOID TE_CursorLeft(struct TextEditContext *tec, LONG numColumns);
VOID TE_CursorRight(struct TextEditContext *tec, LONG numColumns);
VOID TE_CursorToMouse(struct TextEditContext *tec, LONG left, LONG top);
VOID TE_MoveCursorWithMouse(struct TextEditContext *tec, LONG left, LONG top);
BOOL TE_MouseInArea(struct TextEditContext *tec, LONG left, LONG top);
VOID TE_AdjustLeftTop(struct TextEditContext *tec, LONG *leftPtr, LONG *topPtr);
BOOL TE_IsRedrawNecessary(struct TextEditContext *tec);
VOID TE_RedrawIfNecessary(struct TextEditContext *tec);
VOID TE_Refresh(struct TextEditContext *tec);
VOID TE_Activate(struct TextEditContext *tec);
VOID TE_Deactivate(struct TextEditContext *tec);
VOID TE_InitialRefresh(struct TextEditContext *tec);
VOID TE_DrawDisabled(struct TextEditContext *tec);

/* LTP_TextEditClass.c */
ULONG SAVE_DS ASM LTP_TextEditClassDispatcher(REG(a0) Class *cl, REG(a2) Object *o, REG(a1) Msg msg);
...
/* LT_Redraw.c */
VOID LIBENT LT_Redraw(REG(a0) LayoutHandle *handle, REG(d0) LONG id);
