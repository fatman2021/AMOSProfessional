...
#if defined(DO_LEVEL_KIND) || defined(DO_POPUP_KIND) || defined(DO_TAB_KIND) || defined(DO_TEXTEDIT_KIND)
#define DO_BOOPSI_KIND
#endif	/* defined(DO_LEVEL_KIND) || defined(DO_POPUP_KIND) || defined(DO_TAB_KIND) || defined(DO_TEXTEDIT_KIND) */
...
typedef struct TextEditInfo
{
	struct TextEditContext *	tei_Context;
	struct DrawInfo *		tei_DrawInfo;
	struct Image *			tei_Frame;
	UWORD				tei_FrameLeft;
	UWORD				tei_FrameTop;
	struct KeyMap *			tei_AltKeyMap;
	BOOL				tei_Dragging;
	BOOL				tei_NoFilterMode;
	BOOL				tei_ExitHelp;
} TextEditInfo;
