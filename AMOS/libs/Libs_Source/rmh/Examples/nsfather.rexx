...
res=NamedSpaceCreate(name)
if res>0 then do
    call info "Can't create NamedSpace"
    exit
end
do i=0 to 9
    var.i="Ciao" i
end
call NamedSpaceExport(name,"var")
...
do forever
    ...
    if m<9 then do
        call RxsCall("PROGDIR:nschild" name m)
        m=m+1
    end
